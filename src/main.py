...
def main():
    ...
    if args.mode in ['train', 'validate']:
        ...
        open(FilePaths.fn_char_list, 'w',encoding='utf-8').write(''.join(char_list))

        # save words contained in dataset into file
        open(FilePaths.fn_corpus, 'w',encoding='utf-8').write(' '.join(loader.train_words + loader.validation_words))
    ...
    # infer text on test image
        ...
        model = Model(list(open(FilePaths.fn_char_list, encoding='utf-8').read()), decoder_type, must_restore=True, dump=args.dump)
